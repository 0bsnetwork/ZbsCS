...
namespace ZbsCS
{
    public class Node
    {
        public const string TestNetHost = "https://nodes.testnet-0bsnetwork.com";
        public const string MainNetHost = "https://nodes.0bsnetwork.com";

        public const char TestNetChainId = 'T';
        public const char MainNetChainId = 'Z';
        ...
        {
            return GetObject($"addresses/balance/{address}").GetDecimal("balance", Assets.ZBS);
        }

        public decimal GetBalance(string address, int confirmations)
        {
            return GetObject($"addresses/balance/{address}/{confirmations}").GetDecimal("balance", Assets.ZBS);
        }
