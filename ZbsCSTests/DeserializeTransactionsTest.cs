...
namespace ZbsCSTests
{
    ...
    public class DeserializeTransactionsTest
    {
        ...
        public void TestIssueTransactionDeserialize()
        {
            ...
            Assert.AreEqual(issueTx.Fee, Assets.ZBS.LongToAmount(100000000));
        ...
        public void TestTransferTransactionDeserialize()
        {
            ...
            Assert.AreEqual(transferTx.Fee, Assets.ZBS.LongToAmount(100000));
        ...
        public void TestReissueTransactionDeserialize()
        {
            ...
            Assert.AreEqual(reissueTx.Fee, Assets.ZBS.LongToAmount(100000000));
        ...
        public void TestBurnTransactionDeserialize()
        {
            ...
            Assert.AreEqual(burnTx.Fee, Assets.ZBS.LongToAmount(100000));
        ...
        public void TestLeaseTransactionDeserialize()
        {
            ...
            Assert.AreEqual(leaseTx.Fee, Assets.ZBS.LongToAmount(100000));
            ...
            Assert.AreEqual(Assets.ZBS.AmountToLong(leaseTx.Amount), 1658046538);
        ...
        public void TestCancelLeasingTransactionDeserialize()
        {
            ...
            Assert.AreEqual(cancelLeaseTx.Fee, Assets.ZBS.LongToAmount(100000));
        ...
        public void TestAliasTransactionDeserialize()
        {
            ...
            Assert.AreEqual(aliasIx.Fee, Assets.ZBS.LongToAmount(100000));
        ...
        public void TestMassTransferTransactionDeserialize()
        {
            ...
            Assert.AreEqual(massTransferTx.Fee, Assets.ZBS.LongToAmount(4900000));
        ...
        public void TestDataTransactionDeserialize()
        {
            ...
            Assert.AreEqual(dataTx.Fee, Assets.ZBS.LongToAmount(100000));
        ...
        public void TestSetScriptTransactionDeserialize()
        {
            ...
            Assert.AreEqual(setScriptTx.Fee, Assets.ZBS.LongToAmount(2082496));
        ...
        public void TestSponsoredFeeTransactionDeserialize()
        {
            ...
            Assert.AreEqual(sponsoredFeeTx.Fee, Assets.ZBS.LongToAmount(100000000));
        ...
        public void TestInvokeScriptTransactionDeserialize()
        {
            ...
            Assert.AreEqual(invokeScriptTx.FeeAsset, Assets.ZBS);
        ...
        public void TestExchangeTransactionDeserialize()
        {
            ...
            Assert.AreEqual(exchangeTx.Fee, Assets.ZBS.LongToAmount(300000));
            ...
            Assert.AreEqual(exchangeTx.BuyOrder.PriceAsset, Assets.ZBS);
            ...
            Assert.AreEqual(exchangeTx.BuyOrder.MatcherFee, Assets.ZBS.LongToAmount(300000));
            ...
            Assert.AreEqual(exchangeTx.SellOrder.PriceAsset, Assets.ZBS);
            ...
            Assert.AreEqual(exchangeTx.SellOrder.MatcherFee, Assets.ZBS.LongToAmount(300000));
            ...
            Assert.AreEqual(exchangeTx.BuyMatcherFee, Assets.ZBS.LongToAmount(260224));
            Assert.AreEqual(exchangeTx.SellMatcherFee, Assets.ZBS.LongToAmount(19791));
        }
        ...
        public void TestSetAssetScriptTransactionDeserialize()
        {
            ...
            Assert.AreEqual(setAssetScriptTx.Fee, Assets.ZBS.LongToAmount(100000000));
